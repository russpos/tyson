var _ = require('underscore'),
    context = require('./Context').create(),
...
var Executor = {
     ...
     */
    createProvisionScript: function(resourceObject, data) {
        var queue = this.orderDependenciesForObject(resourceObject,
                                                    ResourceIndex.getCatalog());
        this.processQueue(queue, ResourceIndex, context, data);
        return context.generateOutput();
    },
     ...
     * @param Context os A copy of the Context helper to use
